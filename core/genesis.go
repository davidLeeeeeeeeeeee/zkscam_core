...
type Genesis struct {
	...
	// 你添加的字段
	MinerAddresses      []common.Address `json:"minerAddresses"`
	ZkscamHash          common.Hash      `json:"zkscamHash"`
	Signatures          [][]byte         `json:"signatures"`
	BLSPublicKeys       [][]byte         `json:"blsPublicKeys"`
	AuthBLSSignatures   [][]byte         `json:"authBLSSignatures"`
	AggregatedSignature []byte           `json:"aggregatedSignature"`
	Votes               *big.Int         `json:"votes" gencodec:"required"`
	TotalVotes          *big.Int         `json:"totalVotes" gencodec:"required"`
...
func (g *Genesis) ToBlock() *types.Block {
	...
	head := &types.Header{
		...
		// 设置新的字段
		MinerAddresses:      g.MinerAddresses,
		ZkscamHash:          g.ZkscamHash,
		Signatures:          g.Signatures,
		BLSPublicKeys:       g.BLSPublicKeys,
		AuthBLSSignatures:   g.AuthBLSSignatures,
		AggregatedSignature: g.AggregatedSignature,
		Votes:               g.Votes,
